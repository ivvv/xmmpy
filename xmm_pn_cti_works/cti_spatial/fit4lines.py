...
def fit4lines(events: Table,erange: list=(7000.0,10000.0),ebin: float=5.0,use_column: str='PI',
    plot_it: bool=False,verbose: bool=False) -> dict:
    '''
    Purpose:
    ...
    Inputs:
        ...
        use_column - str, which energy column to use, can be 'PI' or 'PI_CORR' for spatial CTI corrected
