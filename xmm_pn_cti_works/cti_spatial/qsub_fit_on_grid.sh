...
#
qsub -N ff0_mnka_1250 -v rev1=1250 ./run_fit_on_grid.sh
qsub -N ff0_mnka_1500 -v rev1=1500 ./run_fit_on_grid.sh
qsub -N ff0_mnka_1750 -v rev1=1750 ./run_fit_on_grid.sh
qsub -N ff0_mnka_2000 -v rev1=2000 ./run_fit_on_grid.sh
# #
